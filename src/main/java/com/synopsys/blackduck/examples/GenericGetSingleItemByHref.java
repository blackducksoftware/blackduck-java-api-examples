...
public class GenericGetSingleItemByHref extends ValidateBlackDuckConnection {
    ...
    private static Logger log = LoggerFactory.getLogger(GenericGetSingleItemByHref.class);

 ...
 *
 * Usage Example : java -cp target\blackduck-java-api-examples-2023.9.0-jar-with-dependencies.jar \
            ...
            if (getSBOMForProjectVersion.validateBlackDuckConnection(restConnector)) {
                try {
                    ...
                    if (projectWrapper.isPresent()) {
                        ...
                        // Note: Whatever is there for BillOfMaterials does not refer to reports but to the Hubs 
                        // own list of dependencies for the webinterface.
